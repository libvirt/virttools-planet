...
class TimeoutSocket:
    ...
    def __getattr__(self, key):
        return getattr(self._sockorig, key)
    # end __getattr__
    ...
    def setblocking(self, blocking):
        ...
        return self._sockorig.setblocking(blocking)
    # end set_timeout
...
class TimeoutFile:
    ...
    def __init__(self, sock, mode="r", bufsize=4096):
        ...
        if not hasattr(sock, "_inqueue"): self._sockorig._inqueue = ""
